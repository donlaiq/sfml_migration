...
Player::Player() : m_Sprite(TextureHolder::GetTexture("graphics/player.png")),
					m_Speed(START_SPEED),
					m_Health(START_HEALTH),
					m_MaxHealth(START_HEALTH)
{
	// Set the origin of the s`rite to the center, for smooth rotation
...
void Player::update(float elapsedTime, Vector2i mousePosition)
{
	...
	float angle = (std::atan2(mousePosition.y - m_Resolution.y / 2, mousePosition.x - m_Resolution.x / 2) * 180) / 3.141;
